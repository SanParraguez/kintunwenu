...
class GesDiscDataset:
    ...
    # =======================================
    def download_products(self, urls, batch_size=None, verbose=1) -> None:
        """
        ...
        if verbose > 0:
            print(f'Started download of netCDF files in {n_batchs} batches')
        ...
        for batch in range(n_batchs):
            ...
            products = download_files(urls=batch_urls, verbose=0, save_files=False)
